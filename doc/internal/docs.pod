...
The documentation is maintained as L<Pod|http://perldoc.perl.org/perlpod.html>
...
will build the documentation in F<html/>.

Internally this uses
L<Pod::Simple::XHTML|http://search.cpan.org/perldoc?Pod::Simple::XHTML>.
