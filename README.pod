...
pdfout is a lightweight PDF toolkit written in C. It is based on the
...
=item - dump and modify outlines, page labels and keys of the information
dictionary. These support JSON for input and output.

=item - extract text

=item - repair broken cross-reference tables
